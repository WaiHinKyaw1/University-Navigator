...
const TOPIC_CHIPS = [
  { label: "🤔 တက္ကသိုလ်မသိသေးဘူး", msg: "တက္ကသိုလ်အကြောင်း သိပ်မသိသေးဘူး။ ဘယ်လို စเริ်่ရမလဲ၊ ဘယ်ကျောင်းတွေ ရှိလဲ ရှင်းပြပေးပါ" },
...
const WELCOME_MESSAGE: ChatbotMessage = {
  id: 0,
  role: "assistant",
  content: "မင်္ဂလာပါ! ကျွန်တော်က G-12 ကျောင်းသားများကို မြန်မာနိုင်ငံတက္ကသိုလ်များအကြောင်း ရှင်းပြပြီး ကျောင်းရွေးချယ်ရာတွင် ကူညီသော AI လမ်းညွှန်ဖြစ်ပါသည်။\n\nတက္ကသိုလ်အကြောင်း မသိသေးရင်လည်း စ worry မလုပ်ပါနဲ့ — ဘာသာ၊ ဝါသနာ၊ သို့ ကျောင်းအမည် မေးချင်တာကို ရိုးရိုးလေး ရိုက်မေးနိုင်ပါသည်။",
          ...
          <div className="max-w-2xl mx-auto space-y-2">
            {!user && (
              <div className="flex items-center justify-between gap-3 bg-gray-50 rounded-xl px-3 py-2 border border-gray-100">
                <p className="text-gray-500 text-xs">စကားဝိုင်း မှတ်တမ်းသိမ်းရန် Sign in လုပ်ပါ</p>
                <Button variant="outline" asChild size="sm" className="shrink-0 h-8">
