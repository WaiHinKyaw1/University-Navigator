...
let adminRows = await query("SELECT id FROM users WHERE role = 'admin' LIMIT 1");
if (adminRows.length === 0) {
  // Create a default admin user (password: admin123 - bcrypt hash)
  adminRows = await query(
    `INSERT INTO users (name, email, password_hash, role) 
     VALUES ($1, $2, $3, $4) RETURNING id`,
    ['Admin', 'admin@university-guide.mm', '$2b$10$kIxmXoUMrC6NVGX0ZKC5QOp1p3dF8P8EKxT1Q.VtXO6mxF.v.Vfwi', 'admin']
  );
}
